...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main Content Grid */}
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 pt-12 sm:pt-16 pb-8">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Empowering minds through innovation and creating lasting impact in
        ...
        >
          ...
          >
            <span className="text-xs sm:text-sm mb-2 sm:mb-3 font-medium group-hover:text-primary">
              Scroll to explore
            </span>
